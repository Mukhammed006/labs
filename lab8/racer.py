...
background = pygame.image.load("lab8/data/road.png")
coin = pygame.image.load("lab8\data\coin.png"),
coini = 0
coins = 0
...
class Enemy(pygame.sprite.Sprite):
      def __init__(self):
        super().__init__() 
        self.image = pygame.image.load("lab8\data\Enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load("lab8\data\Player.png")
        self.rect = self.image.get_rect()
...
coin_x = 0
y = 0
bgsound = pygame.mixer.Sound("lab8/data/background.wav")
bgsound.play()
