...
score_sound = pygame.mixer.Sound(r'C:\Users\Mukha\Desktop\PP2_vs code\lab9\data\score.wav')
...
def snake_game():
    ...
    if game_over:
        ...
        pygame.mixer.init()
        game_over_sound = pygame.mixer.Sound(r'C:\Users\Mukha\Desktop\PP2_vs code\lab9\data\gameover.wav')
